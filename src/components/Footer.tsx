        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm opacity-70">
              {categorias?.map((cat) => (
                <Link key={cat.id} to={`/productos?categoria=${cat.slug}`} className="hover:text-primary transition-colors">
                  {cat.nombre}
                </Link>
              ))}
            </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-4 text-sm">
              <a href="https://goo.gl/maps/tu-link-a-google-maps" target="_blank" className="flex items-start gap-3 opacity-70 hover:opacity-100 transition-opacity">
